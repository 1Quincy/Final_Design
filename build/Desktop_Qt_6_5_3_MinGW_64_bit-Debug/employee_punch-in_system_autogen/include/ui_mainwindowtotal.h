...
"}"));
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/\346\211\223\345\215\241.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/images/\350\257\267\345\201\207.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/images/\344\272\213\345\212\241.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionPermit->setIcon(icon2);
        actionPermit->setMenuRole(QAction::NoRole);
        actionAbout = new QAction(MainWindowTotal);
        actionAbout->setObjectName("actionAbout");
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/images/\345\210\206\346\236\220.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/images/\345\217\260\350\264\246.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/images/login2.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/images/\350\200\203\345\213\244.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/images/\345\212\240\347\217\255.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/images/\345\256\242\346\210\267.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        MainWindowTotal->addToolBar(Qt::TopToolBarArea, toolBar);
