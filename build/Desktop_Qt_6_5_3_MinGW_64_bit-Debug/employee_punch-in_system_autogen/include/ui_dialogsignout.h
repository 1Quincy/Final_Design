...
"}"));
        ...
        BtnOk->setFont(font);
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icon/ok.png"), QSize(), QIcon::Normal, QIcon::Off);
        BtnOk->setIcon(icon);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icon/\345\217\226\346\266\210.png"), QSize(), QIcon::Normal, QIcon::Off);
